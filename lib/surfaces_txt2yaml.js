...
SurfacesTxt2Yaml.Parser = (function() {
  ...
  Parser.prototype.parse = function(txt) {
    var character, data, id, in_scope, index, line, lines, parsed_data, range, range_result, ranges, region_id, regions, result, scope, scope_begin, scope_content, scope_id, scope_id_str, scope_id_value, scope_parser, setting, settings, surface, tooltip, type, _i, _j, _k, _l, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _results;
    parsed_data = {};
    lines = txt.split(/\r?\n/);
    scope = null;
    scope_id = null;
          ...
          if (result[1] === 'descript') {
            ...
            for (_j = 0, _len1 = ranges.length; _j < _len1; _j++) {
              ...
              if (range_result = range.match(/^(\d+)-(\d+)$/)) {
                scope_id = scope_id.concat((function() {
                  _results = [];
                  for (var _k = _ref = range_result[1], _ref1 = range_result[2]; _ref <= _ref1 ? _k <= _ref1 : _k >= _ref1; _ref <= _ref1 ? _k++ : _k--){ _results.push(_k); }
                  return _results;
                }).apply(this));
...
SurfacesTxt2Yaml.ScopeParser.surface = (function(_super) {
  ...
  surface.prototype.match_animation_pattern = function(data, result) {
    var arg, args, args_str, id, name, p_id, type, _is, _ref, _ref1, _ref2, _results;
