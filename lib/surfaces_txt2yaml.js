...
SurfacesTxt2Yaml.Parser = (function() {
  ...
  Parser.prototype.parse = function(txt) {
    var character, data, id, in_scope, index, line, lines, parsed_data, region_id, regions, result, scope, scope_begin, scope_content, scope_id, scope_parser, setting, settings, surface, tooltip, type, _i, _len, _ref, _ref1, _ref2;
    parsed_data = {};
    lines = txt.split(/\r?\n/);
    scope = null;
    scope_id = null;
    ...
    if (parsed_data.cursor != null) {
      ...
      _ref1 = parsed_data.cursor;
      for (character in _ref1) {
        settings = _ref1[character];
    ...
    if (parsed_data.tooltips != null) {
      ...
      _ref2 = parsed_data.tooltips;
      for (character in _ref2) {
        regions = _ref2[character];
        if (parsed_data.regions[character] == null) {
          parsed_data.regions[character] = {};
        }
