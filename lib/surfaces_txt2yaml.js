...
SurfacesTxt2Yaml.ScopeParser.Multiple = (function() {
  function Multiple() {}
  ...
  Multiple.prototype.warn = function(message) {
    return console.warn('line ' + (this.index_offset + this.index + 1) + ': ' + message);
  };

  Multiple.prototype["throw"] = function(message) {
...
SurfacesTxt2Yaml.ScopeParser.Single = (function() {
  ...
  Single.prototype.parse = function(lines, index_offset) {
    var data, index, line, match, result, _i, _len;
    this.index_offset = index_offset;
    data = {};
    for (index = _i = 0, _len = lines.length; _i < _len; index = ++_i) {
      line = lines[index];
...
SurfacesTxt2Yaml.ScopeParser['surface.alias'] = (function(_super) {
  ...
  _Class.prototype.condition = {
    test: /^\s*([^,]+),\[(.+)\]$/,
    match: function(data, result) {
      return data[result[1]] = result[2].split(/\s*,\s*/);
    }
  };
